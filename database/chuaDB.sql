...
SELECT n.newsID, n.title, n.author, n.description, n.paragraph, n.timeUpdated, n.saveDraft, n.newsTypeID, n.photoID, nt.typeName, nt.icon, p.alt, p.photo, p.month, p.year
FROM news n, newsType nt, photo p
WHERE n.photoID = p.photoID AND n.newsTypeID = nt.newsTypeID ORDER BY n.newsID ASC;
...
INSERT INTO `news` (`newsID`, `title`, `author`, `description`, `paragraph`, `timeUpdated`, `saveDraft`, `newsTypeID`, `photoID`)
